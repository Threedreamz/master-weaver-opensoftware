...
export const COMPONENT_DEFINITIONS = {
  ...
  "file-upload": { type: "file-upload", category: "input" as const, icon: "Upload", label: "File Upload", description: "File attachment field", defaultConfig: { acceptBundle: "images_pdf", acceptedTypes: ["image/*", "video/*", "application/pdf", ".dwg", ".zip", "application/zip"], maxFileSizeMb: 10, maxFiles: 3, description: "" }, configSchema: [{ key: "acceptBundle", label: "Erlaubte Formate", type: "select" as const, options: [{ value: "images", label: "Nur Bilder (jpg, png, gif, webp)" }, { value: "images_pdf", label: "Bilder + PDF" }, { value: "all_media", label: "Bilder + Videos + PDF" }, { value: "all", label: "Alle gängigen Formate (Bilder, Videos, PDF, DWG, ZIP u.v.m.)" }] }, { key: "maxFileSizeMb", label: "Max File Size (MB)", type: "number" as const, defaultValue: 10 }, { key: "maxFiles", label: "Max Files", type: "number" as const, defaultValue: 3 }, { key: "description", label: "Help Text", type: "text" as const }] },
  ...
  "contact-form": {
    ...
    description: "Vollständiges Kontaktformular mit Feldern für Name, E-Mail, Telefon und mehr",
    defaultConfig: {
      showFirstName: true,
      showLastName: true,
      showEmail: true,
  ...
  // Button / CTA
  "button": { type: "button", category: "advanced" as const, icon: "MousePointer", label: "Button", description: "Klickbarer Button mit Aktion", defaultConfig: { text: "Weiter", variant: "primary", action: "next", targetStepId: "", externalUrl: "", fullWidth: true, iconLeft: "", iconRight: "ArrowRight", buttonColor: "", buttonTextColor: "", borderColor: "", borderRadius: "", size: "medium" }, configSchema: [{ key: "text", label: "Button-Text", type: "text" as const }, { key: "variant", label: "Variante", type: "select" as const, options: [{ value: "primary", label: "Primär" }, { value: "secondary", label: "Sekundär" }, { value: "outline", label: "Outline" }, { value: "ghost", label: "Ghost" }] }, { key: "action", label: "Aktion", type: "select" as const, options: [{ value: "next", label: "Nächste Seite" }, { value: "previous", label: "Vorherige Seite" }, { value: "jump", label: "Zu Seite springen" }, { value: "url", label: "Externer Link" }] }, { key: "targetStepId", label: "Zielseite", type: "text" as const, condition: { field: "action", value: "jump" } }, { key: "externalUrl", label: "URL", type: "text" as const, condition: { field: "action", value: "url" } }, { key: "fullWidth", label: "Volle Breite", type: "boolean" as const }, { key: "size", label: "Größe", type: "select" as const, options: [{ value: "small", label: "Klein" }, { value: "medium", label: "Mittel" }, { value: "large", label: "Groß" }] }, { key: "buttonColor", label: "Button-Farbe", type: "color" as const }, { key: "buttonTextColor", label: "Textfarbe", type: "color" as const }, { key: "borderColor", label: "Rahmenfarbe", type: "color" as const }, { key: "borderRadius", label: "Rundung", type: "select" as const, options: [{ value: "", label: "Standard (Theme)" }, { value: "0", label: "Eckig" }, { value: "0.25rem", label: "Leicht" }, { value: "0.5rem", label: "Normal" }, { value: "0.75rem", label: "Rund" }, { value: "9999px", label: "Pill" }] }] },
  "submit-button": { type: "submit-button", category: "advanced" as const, icon: "CheckCircle", label: "Absenden-Button", description: "Sendet den Flow final ab und speichert die Submission", defaultConfig: { text: "Absenden", variant: "primary", fullWidth: true, buttonColor: "", buttonTextColor: "", borderColor: "", borderRadius: "", size: "medium" }, configSchema: [{ key: "text", label: "Button-Text", type: "text" as const }, { key: "variant", label: "Variante", type: "select" as const, options: [{ value: "primary", label: "Primär" }, { value: "secondary", label: "Sekundär" }, { value: "outline", label: "Outline" }, { value: "ghost", label: "Ghost" }] }, { key: "fullWidth", label: "Volle Breite", type: "boolean" as const }, { key: "size", label: "Größe", type: "select" as const, options: [{ value: "small", label: "Klein" }, { value: "medium", label: "Mittel" }, { value: "large", label: "Groß" }] }, { key: "buttonColor", label: "Button-Farbe", type: "color" as const }, { key: "buttonTextColor", label: "Textfarbe", type: "color" as const }, { key: "borderColor", label: "Rahmenfarbe", type: "color" as const }, { key: "borderRadius", label: "Rundung", type: "select" as const, options: [{ value: "", label: "Standard (Theme)" }, { value: "0", label: "Eckig" }, { value: "0.25rem", label: "Leicht" }, { value: "0.5rem", label: "Normal" }, { value: "0.75rem", label: "Rund" }, { value: "9999px", label: "Pill" }] }] },

  // Pricing
  "price-display": { type: "price-display", category: "display" as const, icon: "BadgeEuro", label: "Preisanzeige", description: "Zeigt den aktuellen Gesamtpreis live an", defaultConfig: { label: "Geschätzter Preis", showBreakdown: true, style: "card" }, configSchema: [{ key: "label", label: "Bezeichnung", type: "text" as const }, { key: "showBreakdown", label: "Aufschlüsselung anzeigen", type: "boolean" as const }, { key: "style", label: "Style", type: "select" as const, options: [{ value: "card", label: "Karte" }, { value: "inline", label: "Inline" }, { value: "banner", label: "Banner" }] }] },
