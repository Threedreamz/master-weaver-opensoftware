export interface EUCountrySeed {
  ...
  name: string;
  nativeName: string;
  region: "Western" | "Eastern" | "Nordic" | "Southern" | "EFTA";
  population: number;
  gdpEur: number;
  smeCount: number;
  smeEmployees: number;
...
export const MARKET_COUNTRIES: EUCountrySeed[] = [
  ...
  { code: "CH", name: "Switzerland", nativeName: "Schweiz", region: "EFTA", population: 8850000, gdpEur: 807, smeCount: 604000, smeEmployees: 3200000, vatPrefix: "CHE", marketScore: 88 },
...
/** @deprecated Use MARKET_COUNTRIES instead */
export const EU_COUNTRIES = MARKET_COUNTRIES;
