...
export default function MarketMapPage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50 dark:bg-gray-950">
      {/* ---- KPI bar ---- */}
      <div className="flex items-center gap-6 px-6 py-3 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 shrink-0">
      ...
      <div className="flex flex-1 min-h-0 relative">
        ...
        {/* sidebar */}
        <div
          className={`absolute top-0 right-0 h-full w-[400px] bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-800 shadow-xl transform transition-transform duration-300 z-20 ${
    ...
    <div className="p-4 space-y-4 overflow-y-auto h-full">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <div className="text-sm text-gray-500">{plz.countryCode}</div>
        </div>
      </div>
