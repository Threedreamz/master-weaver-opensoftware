...
import { getPermissionsForRole, OPENACCOUNTING_PERMISSIONS } from "@opensoftware/config/rbac";
...
> {
  ...
  const permissions = getPermissionsForRole(OPENACCOUNTING_PERMISSIONS, role);
